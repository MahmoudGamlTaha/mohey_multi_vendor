...
return [
    ...
    'compare'              => 'مقارنة المنتج',
    'addToWishList'        => 'اضافه الى قائمة المفضله',
    'company'              => 'الشركه',
    'subtotal'             => 'الاجمالى',
    'useCoupon'            => 'تطبيق الكوبون',
    'sellProduct'          => 'قم بيع هذا المنتج',
    'newArrivals'          => 'احدث المنتجات',
    'pages'                => 'الصفحات',
    'home'                 => 'الرئيسيه',
...
على سبيل المثال: نصائح إخبارية ، رسائل إخبارية ، ...',
    ...
    'category'           => [
        ...
        'home_page'   => 'عرض منتجاته في الصفحة الرئيسبة',
        'home_page_grid' => 'عرض في الرئيسية'
    ],
    'promotion'          => [
        'code'        => 'Coupon code',
        'value'       => 'Value',
    ...
    'cart'               => [
        ...
        'apply'            => 'Apply',
        'coupon'           => 'ادخل كود الكوبون إذا كان لديك',
    ...
    'errors'    => [
        'required'     => 'يرجى ادخال قيمة هذا الحقل',
        'email'        => 'هذا البريد الالكترونى مستخدم بالفعل برجاء ادخال بريد الكترونى صالح او تسجيل الدخول',
        'image'        => 'يرجى ادخال صورة',
        'mobile'       => 'هذا الرقم مستخدم بالفعل برجاء ادخال رقم صالح او تسجيل الدخول',
    ],
];

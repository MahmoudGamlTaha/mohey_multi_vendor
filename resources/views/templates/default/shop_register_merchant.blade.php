                    ...
                    <form class="col-sm-6"  action="{{route('newMerchant')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div  style="text-align:center;">
                                <h4 style="background: #f69620;padding: 12px 5px;color: white;">{{ trans('language.registerMerchant.account') }}</h4>
                              </div>
                        ...
                        <div class="col-sm-5 form-group" style="text-align:center;padding:0px;">
                            <h4 style="text-align: center ; font-weight: bold"  >مواعيد ساعات العمل<span style="color:red;">*</span></h4>
                        ...
                        <div class="col-sm-7 form-group" name="weekend" style="padding:0px;">

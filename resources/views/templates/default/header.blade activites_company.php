  ...
  <nav class="navbar navbar-default">
    ...
    <div class="collapse navbar-collapse js-navbar-collapse">
      ...
      <li class="dropdown mega-dropdown">
          <a href="#" class="dropdown-toggle orange-bk" data-toggle="dropdown">{{ trans('language.all_categories') }} <span class="glyphicon glyphicon-align-justify pull-right"></span></a>
      ...
      <li class="dropdown">
		<a href="{{ route('categories') }}">{{ trans('language.shops') }}</a>
		</li>

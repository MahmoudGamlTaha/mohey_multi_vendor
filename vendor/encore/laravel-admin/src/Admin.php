...
class Admin
{
    ...
    {
        return sprintf('HC-admin <comment>version</comment> <info>%s</info>', self::VERSION);
    }
    ...
    public function menu()
    {
       ...
       // var_dump($menuModelInstance);
     //   die;
        return ($menuModelInstance)->toTree();
    }
    ...
    {
        return $this->belongsToMany('App\Companies','users','id','company_id');
    }

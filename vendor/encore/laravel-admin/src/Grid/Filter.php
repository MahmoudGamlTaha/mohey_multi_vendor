...
class Filter implements Renderable
{
 ...
 //       array_set($params, 'company_id', 1);
    ...
    public function executeWithCompany( $company, $toArray = true)
    {
        $conditions = $this->conditions();
        $conditions = array_merge(
            $this->conditions(),
        ...
        return $this->model->addConditions($conditions)->buildDataWithCompany($company, $toArray);
    }

...
<div class="dropdown pull-right column-selector" style="margin-right: 10px">
    ...
    <ul class="dropdown-menu" role="menu">
        ...
        <li style="padding: 0 15px;">
            <button class="btn btn-xs btn-instagram column-select-all">reset</button>
            <button class="btn btn-xs btn-primary column-select-submit" style="float: right">Ok</button>
        </li>
    </ul>
</div>
EOT;

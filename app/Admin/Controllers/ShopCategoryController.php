...
class ShopCategoryController extends Controller
{
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            if(!$this->checkSuperUser()){
              $categoryCheck = ShopCategory::find($id); 
              if($categoryCheck->company_id != $this->getUserCompany()[0]->id){
                $content->body( "<b>Item Not Found</b>");
                return;
              }  
            }
    ...
    protected function grid()
    {
        return Admin::grid(ShopCategory::class, function (Grid $grid) {
            ...
            $grid->home_page(trans('language.category.home_page_grid'))->switch()->sortable();
...
//Language
            ...
            $form->switch('home_page', trans('language.category.home_page'))->help(trans('language.category.home_page'))->default(0);
